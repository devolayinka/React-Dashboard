...
import avatarr3 from './avatarr3.png';
import avatarr2 from './avatarr2.jpg';
...
export const EditorData = () => (
  <div>
    <h3>
        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Mollitia, enim ex! Vitae libero similique quas maiores, delectus amet illum.
       
        Quos libero ab nihil ipsam rerum ex vero perspiciatis explicabo in tenetur fuga harum nam, optio vitae culpa? Sapiente aspernatur consequatur officia amet alias officiis minima, laborum et facilis dolorem perspiciatis dolore est quos nobis repudiandae reprehenderit.
        
         Pariatur provident sed delectus molestiae maiores suscipit magni eum blanditiis officia! Quidem beatae accusantium inventore asperiores numquam voluptatibus modi omnis.
          
        Adipisci fuga et, ea expedita, optio reprehenderit eos necessitatibus numquam aut commodi laboriosam voluptas perferendis vero consectetur accusantium repellat iste neque facere, porro omnis nulla enim. 

        Molestias dolorem velit eum animi impedit quae veritatis ullam. Quae nihil officia commodi illum reiciendis similique, dignissimos vitae harum quod quidem possimus sed accusantium cumque corporis qui. 
        
        Obcaecati quos quam, deserunt earum, atque neque perspiciatis culpa iusto laudantium quasi veritatis similique repellendus! Quisquam minus exercitationem, unde autem aperiam repudiandae placeat repellendus praesentium neque quidem sequi repellat magnam fuga vel accusamus nulla, temporibus labore vitae! Accusantium quod nobis 
        quisquam, quas, nesciunt saepe accusamus ipsum, officia dignissimos fugiat vero distinctio corrupti deleniti earum exercitationem sapiente blanditiis explicabo ipsa magnam iusto veniam illo molestiae tenetur minus
       Cupiditate ipsa reiciendis quas ipsam necessitatibus, ducimus quae dolor ea labore officia asperiores, deleniti quaerat nisi dolorem expedita molestias ut perspiciatis beatae accusamus odit magnam et optio non! Voluptates deserunt eveniet dolore incidunt neque hic, saepe impedit eaque, pariatur, ut magni cumque amet unde rem quas sint iure voluptatibus? Repellat sint doloremque corporis error? Quo iste officiis vero nostrum sit at libero accusamus, perferendis sint quae magni necessitatibus voluptates incidunt ullam fuga enim facere quisquam explicabo aliquid. 
    </h3>
  </div>
);
...
export const pieChartData = [
  { x: 'Agriculture', y: 22, text: '22.0%' },
  { x: 'Trade', y: 19.0, text: '19.0%' },
  { x: 'Information And Communication', y: 10.4, text: '10.4%' },
  { x: 'Manufacturing', y: 9.1, text: '9.1%' },
  { x: 'Real Estate', y: 9.4, text: '9.4%' },
  { x: 'Mining and Quarrying', y: 5.2, text: '5.2%' },
  { x: 'Professional,Scientific A and Technical Services', y: 4.2, text: '4.2%' },
