...
const Navbar = () => {
  ...
  return (
    <div className="relative flex justify-between p-2 md:mx-6 md:mr-6">
      <NavButton
        title="Menu"
      ...
      <div className="flex">
        ...
        <TooltipComponent content="Profile" position="BottomCenter">
          ...
          >
            <img className="w-8 h-8 rounded-full" src={avatar1} alt='userProfile' />
            <p>
              <span className="text-gray-400 text-14">Hi,</span>{''}
            <span className="ml-1 font-bold text-gray-400 text-14">Yinka </span>
            </p>
